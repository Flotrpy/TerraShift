  ...
  return (
    <div className="max-w-3xl space-y-10">
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-medium text-ink">Data split</h2>
        <p className="text-ink/75">
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-medium text-ink">RGB model</h2>
        <ul className="list-disc pl-5 space-y-1 text-ink/75 text-sm">
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-medium text-ink">Multispectral model</h2>
        <ul className="list-disc pl-5 space-y-1 text-ink/75 text-sm">
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-medium text-ink">Evaluation</h2>
        <p className="text-ink/75">
