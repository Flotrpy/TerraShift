  ...
  return (
    <div className="max-w-3xl space-y-10">
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-medium text-ink">Research questions</h2>
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-medium text-ink">Dataset</h2>
        <p className="text-ink/75">
      ...
      <section className="space-y-3">
        <h2 className="text-xl font-medium text-ink">Beyond classification: change detection</h2>
        <p className="text-ink/75">
